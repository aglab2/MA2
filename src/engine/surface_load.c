...
static void add_surface_to_cell(s32 dynamic, s32 cellX, s32 cellZ, struct Surface *surface, s32 lowerX, s32 upperX, s32 lowerY, s32 upperY, s32 lowerZ, s32 upperZ) {
    ...
    int fastAdd = dynamic && gCurrCourseNum != COURSE_WB && gCurrCourseNum != COURSE_CCR && gCurrCourseNum != COURSE_CCE && gCurrCourseNum != COURSE_CCK;
 ...
 */
static void load_object_surfaces(TerrainData **data, TerrainData *vertexData, u32 dynamic) {
    s32 i;
