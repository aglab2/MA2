...
static s32 find_wall_collisions_from_list(RBTree* tree, struct WallCollisionData *data) {
    ...
    for (struct SurfaceNode* surfaceNode = rbt_left_right_iterator_init(tree);
         surfaceNode;
         surfaceNode = rbt_left_right_iterator_next(surfaceNode))
    {
...
static u32 celled_coord(s32 coord, s32 cell) {
