...
static void create_dl_scale_matrix(s8 pushOp, f32 x, f32 y, f32 z) {
    Mtx *matrix = (Mtx *) alloc_display_list(sizeof(Mtx));
...
, [ COURSE_PC ] = { .stars = 25, .checkpoints = 6, .goal = true, .has100 = true }
...
, [ COURSE_WC ] = { .stars = 24, .checkpoints = 4, .has100 = true }
