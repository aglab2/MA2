...
void bhv_mario_update(void) {
    ...
    if ((gCurrCourseNum == COURSE_FC && gCurrAreaIndex != 3 && gCurrAreaIndex != 6 && gCurrAreaIndex != 7) || gCurrCourseNum == COURSE_FR || gCurrCourseNum == COURSE_MSP)
    {
