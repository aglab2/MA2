...
#define UCODE_DATA_START gspF3DEX3_LITE_fifoDataStart
...
#define UCODE_DATA_START gspF3DEX3_CHERRY_fifoDataStart
#define UCODE_DATA_END gspF3DEX3_CHERRY_fifoDataEnd
#endif
