...
const GeoLayout bowser_geo_000424[] = {
   GEO_SHADOW(SHADOW_CIRCLE_9_VERTS, 0x9B, 400),
   GEO_OPEN_NODE(),
      GEO_ANIMATED_PART(LAYER_PCL, 0, 0, 0, bowser_seg6_dl_06040358),
      GEO_OPEN_NODE(),
         GEO_ANIMATED_PART(LAYER_PCL, -89, -2, -18, NULL),
         GEO_OPEN_NODE(),
            GEO_ANIMATED_PART(LAYER_PCL, 0, 0, 0, NULL),
            GEO_OPEN_NODE(),
               GEO_ANIMATED_PART(LAYER_PCL, 69, 0, 0, NULL),
               GEO_OPEN_NODE(),
                  GEO_ANIMATED_PART(LAYER_PCL, 85, 0, 0, NULL),
                  GEO_OPEN_NODE(),
                     GEO_ANIMATED_PART(LAYER_PCL, 0, 0, 0, bowser_seg6_dl_0603D200),
                  GEO_CLOSE_NODE(),
                  GEO_ANIMATED_PART(LAYER_PCL, 0, 0, 0, bowser_seg6_dl_0603E6B8),
               GEO_CLOSE_NODE(),
            GEO_CLOSE_NODE(),
         GEO_CLOSE_NODE(),
         GEO_ANIMATED_PART(LAYER_PCL, 0, -32, -112, NULL),
         GEO_OPEN_NODE(),
            GEO_ANIMATED_PART(LAYER_PCL, 0, 0, 0, NULL),
            GEO_OPEN_NODE(),
               GEO_ANIMATED_PART(LAYER_PCL, 0, 0, 0, bowser_seg6_dl_06043698),
               GEO_ASM(0, geo_update_body_rot_from_parent),
            GEO_CLOSE_NODE(),
         GEO_CLOSE_NODE(),
         GEO_ANIMATED_PART(LAYER_PCL, 118, 67, 105, NULL),
         GEO_OPEN_NODE(),
            GEO_ANIMATED_PART(LAYER_PCL, 0, 0, 0, NULL),
            GEO_OPEN_NODE(),
               GEO_ANIMATED_PART(LAYER_PCL, 65, 0, 0, NULL),
               GEO_OPEN_NODE(),
                  GEO_ANIMATED_PART(LAYER_PCL, 49, 0, 0, NULL),
                  GEO_OPEN_NODE(),
                     GEO_ANIMATED_PART(LAYER_PCL, 0, 0, 0, bowser_seg6_dl_0603B208),
                  GEO_CLOSE_NODE(),
                  GEO_ANIMATED_PART(LAYER_PCL, 0, 0, 0, bowser_seg6_dl_060399D8),
               GEO_CLOSE_NODE(),
               GEO_ANIMATED_PART(LAYER_PCL, 0, 0, 0, bowser_seg6_dl_060392E0),
            GEO_CLOSE_NODE(),
         GEO_CLOSE_NODE(),
         GEO_ANIMATED_PART(LAYER_PCL, 0, 136, 130, NULL),
         GEO_OPEN_NODE(),
            GEO_ANIMATED_PART(LAYER_PCL, 0, 0, 0, NULL),
            GEO_OPEN_NODE(),
               GEO_ANIMATED_PART(LAYER_PCL, 61, 0, 0, NULL),
               GEO_OPEN_NODE(),
                  GEO_ANIMATED_PART(LAYER_PCL, -13, 258, 0, bowser_seg6_dl_060431F0),
               GEO_CLOSE_NODE(),
               GEO_SWITCH_CASE(9, geo_switch_bowser_eyes),
               GEO_OPEN_NODE(),
                  GEO_ANIMATED_PART(LAYER_PCL, 0, 0, 0, bowser_seg6_dl_06042348),
                  GEO_ANIMATED_PART(LAYER_PCL, 0, 0, 0, bowser_seg6_dl_060423A0),
                  GEO_ANIMATED_PART(LAYER_PCL, 0, 0, 0, bowser_seg6_dl_060423F8),
                  GEO_ANIMATED_PART(LAYER_PCL, 0, 0, 0, bowser_seg6_dl_06042450),
                  GEO_ANIMATED_PART(LAYER_PCL, 0, 0, 0, bowser_seg6_dl_060424A8),
                  GEO_ANIMATED_PART(LAYER_PCL, 0, 0, 0, bowser_seg6_dl_06042500),
                  GEO_ANIMATED_PART(LAYER_PCL, 0, 0, 0, bowser_seg6_dl_06042558),
                  GEO_ANIMATED_PART(LAYER_PCL, 0, 0, 0, bowser_seg6_dl_060425B0),
                  GEO_ANIMATED_PART(LAYER_PCL, 0, 0, 0, bowser_seg6_dl_06042608),
               GEO_CLOSE_NODE(),
            GEO_CLOSE_NODE(),
         GEO_CLOSE_NODE(),
         GEO_ANIMATED_PART(LAYER_PCL, -118, 67, 105, NULL),
         GEO_OPEN_NODE(),
            ...
            GEO_OPEN_NODE(),
               ...
               GEO_OPEN_NODE(),
                  GEO_ANIMATED_PART(LAYER_PCL, 49, 0, 0, NULL),
                  GEO_OPEN_NODE(),
                     GEO_ANIMATED_PART(LAYER_PCL, 0, 0, 0, bowser_seg6_dl_0603DFB0),
                  GEO_CLOSE_NODE(),
                  GEO_ANIMATED_PART(LAYER_PCL, 0, 0, 0, bowser_seg6_dl_0603C6D0),
               GEO_CLOSE_NODE(),
               GEO_ANIMATED_PART(LAYER_PCL, 0, 0, 0, bowser_seg6_dl_0603BFC8),
            GEO_CLOSE_NODE(),
         GEO_CLOSE_NODE(),
         GEO_ANIMATED_PART(LAYER_PCL, 89, -2, -18, NULL),
         GEO_OPEN_NODE(),
            ...
            GEO_OPEN_NODE(),
               ...
               GEO_OPEN_NODE(),
                  GEO_ANIMATED_PART(LAYER_PCL, 85, 0, 0, NULL),
                  GEO_OPEN_NODE(),
                     GEO_ANIMATED_PART(LAYER_PCL, 0, 0, 0, bowser_seg6_dl_0603A4E8),
                  GEO_CLOSE_NODE(),
                  GEO_ANIMATED_PART(LAYER_PCL, 0, 0, 0, bowser_seg6_dl_0603B948),
               GEO_CLOSE_NODE(),
            GEO_CLOSE_NODE(),
         GEO_CLOSE_NODE(),
         GEO_ANIMATED_PART(LAYER_PCL, 0, 0, 0, NULL),
...
extern Gfx *geo_update_layer_pcl(s32 callContext, struct GraphNode *node, UNUSED void *context);
