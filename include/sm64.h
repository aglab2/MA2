...
enum LayerBatches {
    ...
    LAYER_TRANSPARENT_RED_FLAMES_LAST = LAYER_TRANSPARENT_RED_FLAMES_FIRST + 15,
    LAYER_TRANSPARENT_BLUE_FLAMES_FIRST,
    LAYER_TRANSPARENT_BLUE_FLAMES_LAST = LAYER_TRANSPARENT_BLUE_FLAMES_FIRST + 15,
    LAYER_TRANSPARENT_GREEN_FLAMES_FIRST,
    LAYER_TRANSPARENT_GREEN_FLAMES_LAST = LAYER_TRANSPARENT_GREEN_FLAMES_FIRST + 15,
...
#define ACT_FCGR_WALKING               0x0400047C // (0x040 | ACT_FLAG_MOVING | ACT_FLAG_ALLOW_FIRST_PERSON)
...
#define ACT_FCGR_JUMP                  0x030008B9
