...
#define GEO_OBJ_ROCKET_TRANSLATE_NODE_WITH_DL(layer, ux, uy, uz, displayList) \
    CMD_BBH(GEO_CMD_OBJ_ROCKET_NODE_TRANSLATION, (layer | 0x80), ux), \
    CMD_HH(uy, uz), \
    CMD_PTR(displayList)
...
#define GEO_CRUMBLE_TRANSLATE_NODE_WITH_DL(layer, ux, uy, uz, displayList) \
