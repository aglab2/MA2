...
extern const BehaviorScript bhvMessagePanelDynamic[];
...
extern const BehaviorScript bhvGfVine[];
...
extern const BehaviorScript bhvMHMusic[];
...
extern const BehaviorScript bhvSoMoveStill[];
...
extern const BehaviorScript bhvCCTPlat[];
extern const BehaviorScript bhvCCEDeath[];
extern const BehaviorScript bhvCCRDucks[];
...
extern const BehaviorScript bhvCCKDoor[];
...
extern const BehaviorScript bhvCwRotCtl[];
extern const BehaviorScript bhvFcSpeed[];
...
extern const BehaviorScript bhvClamShellCC[];
