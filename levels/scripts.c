...
const LevelScript level_main_scripts_entry[] = {
    ...
    ALLOC_LEVEL_POOL(),
    LOAD_MODEL_FROM_GEO_NO_HEAP(MODEL_MARIO,           mario_geo),
...
const LevelScript script_func_global_15[] = {
    ...
    LOAD_MODEL_FROM_GEO_NO_HEAP(MODEL_KOOPA_WITH_SHELL,        koopa_with_shell_geo),
    LOAD_MODEL_FROM_GEO_NO_HEAP(MODEL_KOOPA_WITHOUT_SHELL,     koopa_without_shell_geo),
