...
const LevelScript level_cct_entry[] = {
	...
	LOAD_MODEL_FROM_GEO(MODEL_CCT_GATE_HIT, cc_goaldoor_hit_geo),
	LOAD_MODEL_FROM_GEO(MODEL_CCT_GATE_HIT_BREAK, cc_goaldoor_hitbreak_geo),
	...
	LOAD_MODEL_FROM_GEO(MODEL_CCT_PLATFORM_BIG, cct_step_geo),
	LOAD_MODEL_FROM_GEO(MODEL_CCT_PLATFORM, cct_stepb_geo),
	...
	AREA(1, cct_area_1, 0,0,0),
		...
		MARIO_POS(0x01, 0, 9993, 7863, 9996),
		...
		OBJECT(MODEL_NONE, 6013, 7156, 5003, 0, 0, 0, 0x00000000, bhvShutter),
		...
		OBJECT(MODEL_NONE, -9897, -5924, -6632, 0, 90, 0, 0x00000000, bhvShutter),
		OBJECT(MODEL_NONE, -9894, -5924, -11147, 0, 90, 0, 0x00000000, bhvShutter),
		...
		OBJECT(MODEL_CCT_PLATFORM_BIG, -1734, 783, -5504, 0, 0, 0, 0x00000000, bhvCCTPlatformBig),
		OBJECT(MODEL_CCT_PLATFORM_BIG, -3234, -1717, -5504, 0, 0, 0, 0x00000000, bhvCCTPlatformBig),
		OBJECT(MODEL_CCT_PLATFORM_BIG, -4734, -4717, -5504, 0, 0, 0, 0x00000000, bhvCCTPlatformBig),
		OBJECT(MODEL_CCT_PLATFORM_BIG, -3234, -4717, -4504, 0, 90, 0, 0x00000000, bhvCCTPlatformBig),
		OBJECT(MODEL_CCT_PLATFORM_BIG, -3234, -4717, -6504, 0, -90, 0, 0x00000000, bhvCCTPlatformBig),
		...
		OBJECT(MODEL_NONE, -1734, 1005, -5504, 0, 0, 0, 0x00000000, bhvHiddenStarTrigger),
		OBJECT(MODEL_NONE, -3234, -1495, -5504, 0, 0, 0, 0x00000000, bhvHiddenStarTrigger),
		OBJECT(MODEL_NONE, -4734, -4495, -5504, 0, 0, 0, 0x00000000, bhvHiddenStarTrigger),
		OBJECT(MODEL_NONE, -3234, -4495, -4504, 0, 90, 0, 0x00000000, bhvHiddenStarTrigger),
		OBJECT(MODEL_NONE, -3234, -4495, -6504, 0, -90, 0, 0x00000000, bhvHiddenStarTrigger),
		OBJECT(MODEL_SNUFIT, -10601, -4816, -15561, 0, 90, 0, 0x00000000, bhvSnufit),
		OBJECT(MODEL_SNUFIT, -9279, -4816, -15561, 0, 90, 0, 0x00000000, bhvSnufit),
		OBJECT(MODEL_SNUFIT, -10311, -4816, -14482, 0, 90, 0, 0x00000000, bhvSnufit),
		OBJECT(MODEL_SNUFIT, -9569, -4816, -14482, 0, 90, 0, 0x00000000, bhvSnufit),
		...
		OBJECT(MODEL_STAR, -1734, 1317, -5504, 0, 0, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_STAR, -1138, -5665, -5510, 0, 0, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_NONE, -7427, -5690, -5401, 0, 0, 0, 0x00000000, bhvHiddenStar),
		OBJECT(MODEL_STAR, -9897, -5032, -7990, 0, 0, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_THWOMP, -9882, -5924, -7602, 0, 90, 0, 0x00000000, bhvThwomp2),
		OBJECT(MODEL_THWOMP, -10325, -5924, -7602, 0, 90, 0, 0x00000000, bhvThwomp2),
		OBJECT(MODEL_THWOMP, -9482, -5924, -7602, 0, 90, 0, 0x00000000, bhvThwomp2),
		OBJECT(MODEL_THWOMP, -9882, -5924, -8602, 0, 90, 0, 0x00000000, bhvThwomp2),
		OBJECT(MODEL_THWOMP, -10325, -5924, -8602, 0, 90, 0, 0x00000000, bhvThwomp2),
		OBJECT(MODEL_THWOMP, -9482, -5924, -8602, 0, 90, 0, 0x00000000, bhvThwomp2),
		OBJECT(MODEL_THWOMP, -9882, -5924, -9602, 0, 90, 0, 0x00000000, bhvThwomp2),
		OBJECT(MODEL_THWOMP, -10325, -5924, -9602, 0, 90, 0, 0x00000000, bhvThwomp2),
		OBJECT(MODEL_THWOMP, -9482, -5924, -9602, 0, 90, 0, 0x00000000, bhvThwomp2),
		OBJECT(MODEL_THWOMP, -9882, -5924, -10602, 0, 90, 0, 0x00000000, bhvThwomp2),
		OBJECT(MODEL_THWOMP, -10325, -5924, -10602, 0, 90, 0, 0x00000000, bhvThwomp2),
		OBJECT(MODEL_THWOMP, -9482, -5924, -10602, 0, 90, 0, 0x00000000, bhvThwomp2),
		...
		OBJECT(MODEL_CCT_TIMESTOP, -9880, -5026, -9900, 90, 0, 0, 0x00000000, bhvCCTimestop),
