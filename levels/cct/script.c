...
const LevelScript level_cct_entry[] = {
	...
	AREA(1, cct_area_1, 0,0,0),
		...
		OBJECT(MODEL_CCT_PLATFORM_BIG, -3234, 687, -6504, 0, -90, 0, 0x00000000, bhvCCTPlatformBig),
		OBJECT(MODEL_CCT_PLATFORM_BIG, -4734, -5964, -5504, 0, 0, 0, 0x00000000, bhvCCTPlatformBig),
		OBJECT(MODEL_CCT_PLATFORM_BIG, -3234, -5456, -4504, 0, 90, 0, 0x00000000, bhvCCTPlatformBig),
		OBJECT(MODEL_CCT_PLATFORM_BIG, -3234, -5467, -6504, 0, -90, 0, 0x00000000, bhvCCTPlatformBig),
		...
		OBJECT(MODEL_CCT_PLATFORM_BIG, -1756, -4717, -5504, 0, -180, 0, 0x00000000, bhvCCTPlatformBig),
		...
		OBJECT(MODEL_NONE, -3234, 909, -6504, 0, -90, 0, 0x00000000, bhvHiddenStarTrigger),
		OBJECT(MODEL_NONE, -4734, -5742, -5504, 0, 0, 0, 0x00000000, bhvHiddenStarTrigger),
		OBJECT(MODEL_NONE, -3234, -5234, -4504, 0, 90, 0, 0x00000000, bhvHiddenStarTrigger),
		OBJECT(MODEL_NONE, -3234, -5245, -6504, 0, -90, 0, 0x00000000, bhvHiddenStarTrigger),
		...
		OBJECT(MODEL_STAR, -1138, -4476, -5510, 0, 0, 0, 0x00000000, bhvStar),
		...
		OBJECT(MODEL_CCT_TIMESTOP, 103, 1843, -5387, 90, 0, -90, 0x00000000, bhvCCTimestop),
