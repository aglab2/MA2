...
const LevelScript level_cct_entry[] = {
	...
	AREA(1, cct_area_1, 0,0,0),
		...
		OBJECT(MODEL_NONE, -405, 1072, -5401, 0, -180, 0, 0x00000000, bhvShutter),
		...
		OBJECT(MODEL_THWOMP, -9882, -5924, -9052, 0, 90, 0, 0x00000000, bhvThwomp2),
		OBJECT(MODEL_THWOMP, -10325, -5924, -9052, 0, 90, 0, 0x00000000, bhvThwomp2),
		OBJECT(MODEL_THWOMP, -9482, -5924, -9052, 0, 90, 0, 0x00000000, bhvThwomp2),
