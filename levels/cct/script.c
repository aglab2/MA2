...
const LevelScript level_cct_entry[] = {
	...
	LOAD_MODEL_FROM_GEO(MODEL_CCT_BLOCKLA, cct_blockla_geo), 
	...
	AREA(1, cct_area_1, 0, 0, 0),
		...
		OBJECT(MODEL_CCT_BLOCKLA, -9882, -5606, -10004, 0, 0, 0, 0x00000000, bhvCCTBlock),
		...
		OBJECT(MODEL_CCT_TIMESTOP, -7368, -5924, -5401, 0, 0, 0, (150 << 24), bhvCCTimestop),
