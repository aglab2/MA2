...
const LevelScript level_cct_entry[] = {
	...
	AREA(1, cct_area_1, 0,0,0),
		...
		OBJECT(MODEL_CCT_PLATFORM_BIG, -3234, -91, -6504, 0, -90, 0, 0x00000000, bhvCCTPlatformBig),
		OBJECT(MODEL_CCT_PLATFORM_BIG, -3234, -5658, -3972, 0, 90, 0, (1 << 16), bhvCCTPlatformBig),
		...
		OBJECT(MODEL_NONE, -3234, 131, -6504, 0, -90, 0, 0x00000000, bhvHiddenStarTrigger),
		OBJECT(MODEL_NONE, -4734, -5742, -5504, 0, 0, 0, 0x00000000, bhvHiddenStarTrigger),
		OBJECT(MODEL_NONE, -3234, -5234, -3976, 0, 90, 0, 0x00000000, bhvHiddenStarTrigger),
		OBJECT(MODEL_NONE, -3234, -5245, -6882, 0, -90, 0, 0x00000000, bhvHiddenStarTrigger),
		...
		OBJECT(MODEL_STAR, -1138, -5367, -5510, 0, 0, 0, 0x00000000, bhvStar),
		...
		OBJECT(MODEL_CCT_TIMESTOP, -3234, -5456, -5523, 0, 90, 0, 0x00000000, bhvCCTimestop),
