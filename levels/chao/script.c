...
const LevelScript level_chao_entry[] = {
	...
	AREA(1, chao_area_1, 0, 0, 0),
		...
		OBJECT(MODEL_CHECKPOINT, 4, 0, 958, 0, 0, 0, 0x00000000, bhvCheckpoint),
		...
		OBJECT(MODEL_NONE, 9282, 875, 152, 0, -3, 0, 0x00000000, bhvCoinFormation),
		OBJECT(MODEL_NONE, 9293, 612, -1777, 0, -3, 0, 0x00000000, bhvCoinFormation),
		...
		OBJECT(MODEL_SKEETER, 5835, -940, -5554, 0, -91, 0, 0x00000000, bhvSkeeter),
		...
		OBJECT(MODEL_STAR, 5072, 811, -2816, 0, -91, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_STAR, 4911, 1053, -2552, 0, -91, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_NONE, 5001, 503, -2280, 0, -91, 0, 0x00000000, bhvHiddenRedCoinStar),
		...
		OBJECT(MODEL_STAR, 11764, 2233, 4203, 0, -91, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_STAR, 3656, 882, 4180, 0, -91, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_STAR, 8209, -273, 1782, 0, -91, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_STAR, 5400, 1191, 2402, 0, -91, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_STAR, 6126, 691, 766, 0, -91, 0, 0x00000000, bhvStar),
