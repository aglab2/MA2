...
const LevelScript level_lb_entry[] = {
	...
	AREA(1, lb_area_1, 0, 0, 0),
		...
		WARP_NODE(0x0C, LEVEL_CASTLE_GROUNDS, 1, 0x0B, WARP_NO_CHECKPOINT),
		WARP_NODE(0x0D, LEVEL_CASTLE_GROUNDS2, 1, 0x0B, WARP_NO_CHECKPOINT),
		WARP_NODE(0x0E, LEVEL_GG, 1, 0x0A, WARP_NO_CHECKPOINT),
