...
const LevelScript level_mh_entry[] = {
	...
	AREA(1, mh_area_1, 2000, 0, -900),
		...
		OBJECT(MODEL_BLACK_BOBOMB, 2976, -2095, -13319, 0, -180, 0, 0x00000000, bhvBobomb),
	...
	AREA(3, mh_area_3, 2000, 0, -8900),
		...
		WARP_NODE(0xf0, LEVEL_CASTLE_GROUNDS, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xf1, LEVEL_CASTLE_GROUNDS, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_BLACK_BOBOMB, 15329, -360, 17975, 0, -180, 0, 0x00000000, bhvBobomb),
		OBJECT(MODEL_BLACK_BOBOMB, 15847, 1525, 17174, 0, -180, 0, 0x00000000, bhvBobomb),
		...
		OBJECT(MODEL_NONE, 13311, -1942, 18101, 0, -180, 0, (17 << 16), bhvCoinFormation),
		OBJECT(MODEL_NONE, 13311, -531, 18101, 0, -180, 0, (17 << 16), bhvCoinFormation),
		OBJECT(MODEL_NONE, 15647, 22, 18072, 0, -180, 0, (17 << 16), bhvCoinFormation),
	...
	AREA(4, mh_area_4, 6000, 916, -8900),
		...
		OBJECT(MODEL_NONE, -18365, -11524, -4905, 0, -180, 0, (17 << 16), bhvCoinFormation),
		OBJECT(MODEL_NONE, -18365, -10097, -4905, 0, -180, 0, (17 << 16), bhvCoinFormation),
		...
		OBJECT(MODEL_NONE, -7064, 13831, -13164, 0, 90, 0, (12 << 16), bhvWarp),
