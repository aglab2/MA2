...
const LevelScript level_mh_entry[] = {
	...
	AREA(1, mh_area_1, 2000, 0, -900),
		...
		OBJECT(MODEL_STAR, 3280, -1888, -16201, 0, -180, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_STAR, 234, -2, -24339, 0, -180, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_STAR, 258, 605, -25202, 0, -180, 0, 0x00000000, bhvStar),
	...
	AREA(3, mh_area_3, 2000, 0, -8900),
		...
		OBJECT(MODEL_STAR, 3941, 594, 18595, 0, -180, 0, 0x00000000, bhvStar),
	...
	AREA(4, mh_area_4, 6000, 916, -8900),
		...
		WARP_NODE(0xf0, LEVEL_CASTLE_GROUNDS, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xf1, LEVEL_CASTLE_GROUNDS, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(11, LEVEL_MH, 0x01, 12, WARP_NO_CHECKPOINT),
		WARP_NODE(12, LEVEL_MH, 0x01, 11, WARP_NO_CHECKPOINT),
