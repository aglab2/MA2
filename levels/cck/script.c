...
const LevelScript level_cck_entry[] = {
	...
	AREA(1, cck_area_1, 0, 0, 0),
		...
		OBJECT(MODEL_NONE, -29, 2850, -2022, 0, 0, 0, (20 << 16), bhvCoinFormation),
		OBJECT(MODEL_NONE, -12, 302, -2080, 0, -180, 0, (4 << 16), bhvCoinFormation),
		OBJECT(MODEL_NONE, 0, 6300, 2302, 0, -180, 0, (20 << 16), bhvCoinFormation),
		OBJECT(MODEL_CC_TIMESTOP, -17, -1000, -7986, 0, 90, 0, 0x00000000, bhvCCTimestop),
		OBJECT(MODEL_CC_TIMESTOP, -2, -1700, -5492, 0, 90, 0, (2 << 16), bhvCCTimestop),
		OBJECT(MODEL_CC_TIMESTOP, 4, 300, -7, 0, 90, 0, (2 << 16), bhvCCTimestop),
		OBJECT(MODEL_CC_TIMESTOP, -2070, 550, -40, 0, -180, 0, 0x00000000, bhvCCTimestop),
		OBJECT(MODEL_CC_TIMESTOP, 2082, 0, 47, 0, -180, 0, 0x00000000, bhvCCTimestop),
		OBJECT(MODEL_CC_TIMESTOP, -7, 2850, -4595, 0, -180, 0, (2 << 16), bhvCCTimestop),
		OBJECT(MODEL_CC_TIMESTOP, -14, 3450, -8292, 0, -180, 0, (2 << 16), bhvCCTimestop),
		OBJECT(MODEL_CC_TIMESTOP, -5, 6600, -1894, 0, -180, 0, 0x00000000, bhvCCTimestop),
		OBJECT(MODEL_CC_TIMESTOP, 1, 6300, 1602, 0, 90, 0, (2 << 16), bhvCCTimestop),
		OBJECT(MODEL_CC_TIMESTOP, 3080, -1050, -17345, 0, -90, 0, 0x00000000, bhvCCTimestop),
		OBJECT(MODEL_CC_TIMESTOP, -798, 4647, 801, 0, 0, 0, (17 << 16), bhvCCTimestop),
		OBJECT(MODEL_CC_TIMESTOP, 611, 3087, -6941, 0, 0, 0, (17 << 16), bhvCCTimestop),
		OBJECT(MODEL_CC_TIMESTOP, -623, 3087, -6933, 0, 0, 0, (17 << 16), bhvCCTimestop),
