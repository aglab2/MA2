...
const LevelScript level_cck_entry[] = {
	...
	AREA(1, cck_area_1, 0, 0, 0),
		WARP_NODE(0x0A, LEVEL_CCS, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		...
		OBJECT(MODEL_NONE, -19, 3768, -7931, 0, 135, 0, 0x00000000, bhvFish),
		OBJECT(MODEL_NONE, 4516, -627, -17368, 0, 135, 0, 0x00000000, bhvFish),
		OBJECT(MODEL_CHECKPOINT, -2, 2850, -5456, 0, -180, 0, 0x00000000, bhvCheckpoint),
		...
		OBJECT(MODEL_NONE, -7, 2850, -4595, 0, -180, 0, 0x00000000, bhvCoinFormation),
		...
		OBJECT(MODEL_NONE, 0, 1380, -36, 0, 0, 0, 0x00000000, bhvFish),
		OBJECT(MODEL_NONE, -17, -251, -8435, 0, 135, 0, 0x00000000, bhvFish),
		OBJECT(MODEL_NONE, 0, 3576, -36, 0, 0, 0, 0x00000000, bhvFish),
		OBJECT(MODEL_NONE, 2, 6300, 3010, 0, 0, 0, (1 << 16), bhvCCKGate),
		OBJECT(MODEL_NONE, -2, 2850, -2527, 0, -180, 0, 0x00000000, bhvCCKGate),
		OBJECT(MODEL_NONE, 0, 6521, 0, 0, 0, 0, (0xa << 16), bhvInstantActiveWarp),
		...
		OBJECT(MODEL_NONE, 1350, -950, -17350, 0, 90, 0, (2 << 16), bhvCCKCurrent),
		...
		OBJECT(MODEL_STAR, 3, -1397, -4606, 0, 0, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_STAR, -809, 2368, -794, 0, 0, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_STAR, -12, 325, 1219, 0, 0, 0, 0x00000000, bhvStar),
		...
		OBJECT(MODEL_STAR, 5, 4210, -14202, 0, 0, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_STAR, 2566, -1581, -17976, 0, 0, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_STAR, -5, 8269, 3237, 0, 0, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_K_SOURCE, -5, 7900, -848, 0, 0, 0, 0x00000000, bhvKSource),
		...
		OBJECT(MODEL_K_PLAT, -5, 6843, 7, 0, 0, 0, 0x00000000, bhvKPlat),
