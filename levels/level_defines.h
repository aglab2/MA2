...
DEFINE_LEVEL("CASTLE_GROUNDS2", LEVEL_CASTLE_GROUNDS2, COURSE_NONE, castle_grounds2, generic, 20000, 0x00, 0x00, 0x00, _, sCamCastleGrounds2) 
...
DEFINE_LEVEL("LF", LEVEL_LF, COURSE_LF, lf, generic, 20000, 0x00, 0x00, 0x00, _, sCamLf) 
