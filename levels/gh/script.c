...
const LevelScript level_gh_entry[] = {
	...
	AREA(1, gh_area_1, 0, -174, -900),
		...
		OBJECT(MODEL_CHECKPOINT, -2725, 3045, -11385, 0, -90, 0, 0x00000000, bhvCheckpoint),
		...
		OBJECT(MODEL_NONE, 8, 2495, 8395, 0, 90, 0, (0xa << 16), bhvInstantActiveWarp),
	...
	AREA(2, gh_area_2, 0, -674, -4900),
		WARP_NODE(0x0A, LEVEL_CASTLE_GROUNDS, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xf0, LEVEL_CASTLE_GROUNDS, 1, 0x54, WARP_NO_CHECKPOINT),
		WARP_NODE(0xf1, LEVEL_CASTLE_GROUNDS, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		...
		OBJECT(MODEL_CHECKPOINT, -9688, 5445, 8741, 0, -180, 0, 0x00000000, bhvCheckpoint),
		...
		OBJECT(MODEL_GH_PLAT, -13432, 1015, -2142, 0, 90, 0, 0x00000000, bhvGhPlat),
		OBJECT(MODEL_GH_PLAT, -15012, 315, -1742, 0, -180, 0, 0x00000000, bhvGhPlat),
		...
		OBJECT(MODEL_GH_PLAT, -11818, 1015, -2142, 0, -180, 0, 0x00000000, bhvGhPlat),
		OBJECT(MODEL_GH_PLAT, -7500, 6323, 264, 0, -90, 0, 0x00000000, bhvGhPlat),
		OBJECT(MODEL_STAR, -9346, 8520, 12642, 0, 0, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_STAR, -8909, 5205, 11705, 0, 0, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_STAR, -10686, 6218, 3302, 0, 0, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_STAR, -9755, 7842, -2145, 0, 0, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_STAR, -9247, 6048, -1137, 0, 0, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_STAR, -6728, 1249, -1601, 0, 0, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_STAR, -15000, 1060, -1766, 0, 0, 0, 0x00000000, bhvStar),
