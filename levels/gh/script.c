...
const LevelScript level_gh_entry[] = {
	...
	AREA(1, gh_area_1, 0, -174, -900),
		...
		OBJECT(MODEL_NONE, -2725, 3045, -11385, 0, -90, 0, 0x00000000, bhvCheckpoint),
		...
		OBJECT(MODEL_GOAL, -7751, 2245, -17000, 0, -180, 0, (2 << 16), bhvCoinFormation),
		OBJECT(MODEL_GOAL, -8896, 2445, -17731, 0, -180, 0, (2 << 16), bhvCoinFormation),
		OBJECT(MODEL_GOAL, 1892, 2165, -4693, 0, -180, 0, (2 << 16), bhvCoinFormation),
		OBJECT(MODEL_GOAL, -17, 2145, 9574, 0, -180, 0, (2 << 16), bhvCoinFormation),
		OBJECT(MODEL_GOAL, 32, 2145, 6357, 0, -180, 0, (2 << 16), bhvCoinFormation),
		OBJECT(MODEL_GOAL, 9, 2145, 3184, 0, -180, 0, (2 << 16), bhvCoinFormation),
		...
		OBJECT(MODEL_STAR, -1327, 837, -12363, 0, 0, 0, 0x00000000, bhvStar),
	...
	AREA(2, gh_area_2, 0, -674, -4900),
		...
		OBJECT(MODEL_NONE, -9688, 5445, 8741, 0, -180, 0, 0x00000000, bhvCheckpoint),
		...
		OBJECT(MODEL_GOAL, -19696, -6659, -19300, 0, -180, 0, (2 << 16), bhvCoinFormation),
		OBJECT(MODEL_GOAL, -20301, -1255, -6986, 0, -180, 0, (2 << 16), bhvCoinFormation),
		OBJECT(MODEL_GOAL, -20276, -1229, -2787, 0, -180, 0, (2 << 16), bhvCoinFormation),
		...
		OBJECT(MODEL_GH_PLAT, -10844, 5147, 5019, 0, -180, 0, 0x00000000, bhvGhPlat),
		OBJECT(MODEL_STAR, -9346, 8520, 12642, 0, 0, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_STAR, -8909, 5081, 11705, 0, 0, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_STAR, -10686, 6218, 3302, 0, 0, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_STAR, -9755, 7345, -2145, 0, 0, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_STAR, -9247, 6048, -1137, 0, 0, 0, 0x00000000, bhvStar),
		...
		OBJECT(MODEL_STAR, -18244, -5146, -9631, 0, 0, 0, 0x00000000, bhvStar),
		...
		OBJECT(MODEL_NONE, -7320, 640, -1300, 0, -180, 0, (1 << 24), bhvGhWarp),
		OBJECT(MODEL_NONE, -8520, 502, -2107, 0, 90, 0, (1 << 16), bhvGhWarp),
