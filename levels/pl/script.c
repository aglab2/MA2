...
const LevelScript level_pl_entry[] = {
	...
	AREA(1, pl_area_1, -2000, 0, 0),
		...
		OBJECT(MODEL_CHECKPOINT, 17101, -30, -103, 0, -90, 0, 0x00000000, bhvCheckpoint),
		...
		OBJECT(MODEL_PL_CAGE, -5387, 6300, -6156, 0, 0, 0, (4 << 16), bhvPLCage),
		OBJECT(MODEL_PL_CAGE, -7042, 6300, -5667, 0, 67, 0, (5 << 16), bhvPLCage),
		OBJECT(MODEL_PL_CAGE, -7053, 6300, -3671, 0, 67, 0, (6 << 16), bhvPLCage),
		OBJECT(MODEL_PL_CAGE, -8737, 6300, -2753, 0, 0, 0, (7 << 16), bhvPLCage),
		...
		OBJECT(MODEL_PL_CAGE, 21059, -30, -1051, 0, -180, 0, (11 << 16), bhvPLCage),
