...
#include "levels/credits/header.h"
...
const LevelScript level_credits_entry[] = {
	INIT_LEVEL(),
	LOAD_MIO0(0x7, _credits_segment_7SegmentRomStart, _credits_segment_7SegmentRomEnd), 
	ALLOC_LEVEL_POOL(),
	MARIO(MODEL_MARIO, 0x00000001, bhvMario), 
	/* Fast64 begin persistent block [level commands] */
	/* Fast64 end persistent block [level commands] */

	AREA(1, credits_area_1, 0, 0, 0),
		WARP_NODE(0x0A, LEVEL_CASTLE_GROUNDS, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_NONE, 0, 0, 0, 0, 0, 0, (0xa << 16), bhvInstantActiveWarp),
		OBJECT(MODEL_NONE, 0, 0, 0, 0, 0, 0, (0xa << 16), bhvCreditsCtl),
		TERRAIN(credits_area_1_collision),
		MACRO_OBJECTS(credits_area_1_macro_objs),
