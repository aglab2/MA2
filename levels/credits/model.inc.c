Vtx credits_dl_Plane_mesh_layer_1_vtx_cull[8] = {
...
Vtx credits_dl_Plane_mesh_layer_1_vtx_0[4] = {
...
Gfx credits_dl_Plane_mesh_layer_1[] = {
	gsSPClearGeometryMode(G_LIGHTING),
	gsSPVertex(credits_dl_Plane_mesh_layer_1_vtx_cull + 0, 8, 0),
	...
	gsSPVertex(credits_dl_Plane_mesh_layer_1_vtx_0 + 0, 4, 0),
