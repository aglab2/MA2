...
const LevelScript level_ms_entry[] = {
	...
	AREA(1, ms_area_1, 1000, 0, -1800),
		...
		OBJECT(MODEL_NONE, -14817, -75, -1511, 0, 0, 0, 0x00000000, bhvCoinFormation),
		...
		OBJECT(MODEL_NONE, -21459, 3500, -11891, 0, 0, 0, 0x00000000, bhvCoinFormation),
		OBJECT(MODEL_NONE, -15601, 2830, -11841, 0, 0, 0, 0x00000000, bhvCoinFormation),
		OBJECT(MODEL_NONE, 4796, 2000, -15906, 0, 0, 0, 0x00000000, bhvCoinFormation),
		OBJECT(MODEL_GOAL, 61437, 6767, -51080, 0, 0, 0, 0x00000000, bhvGoal),
		OBJECT(MODEL_MS_HAMMER, -21918, 1158, -10941, 0, 0, 0, 0x00000000, bhvHammerUpDown),
		OBJECT(MODEL_MS_HAMMER, -22318, 1158, -10941, 0, 0, 0, 0x00000000, bhvHammerUpDown),
		OBJECT(MODEL_MS_HAMMER, -23016, 1728, -10941, 0, 0, 0, (80 << 16), bhvHammerUpDown),
		OBJECT(MODEL_MS_HAMMER, -23016, 1728, -11141, 0, 0, 0, (80 << 16), bhvHammerUpDown),
		OBJECT(MODEL_MS_HAMMER, -23016, 2174, -12012, 0, 0, 0, (160 << 16), bhvHammerUpDown),
		OBJECT(MODEL_MS_HAMMER, 22498, 4413, -21531, 0, 0, 0, (120 << 16), bhvHammerUpDown),
		OBJECT(MODEL_MS_HAMMER, 22498, 5144, -21931, 0, 0, 0, (0 << 16), bhvHammerUpDown),
		...
		OBJECT(MODEL_MS_BREAK, -18350, -75, -1505, 0, 0, 0, 0x00000000, bhvMsBreak),
		OBJECT(MODEL_MS_BREAK, 9176, 2000, -15919, 0, 0, 0, (3 << 16), bhvMsBreak),
		...
		OBJECT(MODEL_STAR, 25159, 3500, -16061, 0, 0, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_STAR, 23483, 3816, -21667, 0, 0, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_STAR, 23509, 6577, -23773, 0, 0, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_STAR, 35108, 5237, -24070, 0, 0, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_STAR, 39643, 6585, -35091, 0, 0, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_STAR, 61382, 6800, -50163, 0, 0, 0, 0x00000000, bhvStar),
		...
		OBJECT(MODEL_STAR, 54094, 6146, -44141, 0, 0, 0, 0x00000000, bhvStar),
		...
		OBJECT(MODEL_WHOMP, -16633, -75, -1505, 0, 0, 0, 0x00000000, bhvSmallWhomp),
	...
	AREA(2, ms_area_2, 5000, 0, -1800),
		...
		WARP_NODE(0xf0, LEVEL_CASTLE_GROUNDS, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xf1, LEVEL_CASTLE_GROUNDS, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_NONE, -16506, 2000, -15888, 0, 0, 0, (2 << 16), bhvCoinFormation),
