...
const LevelScript level_cg_entry[] = {
	...
	AREA(1, cg_area_1, -2000, 89, -2000),
		...
		OBJECT(MODEL_THI_WARP_PIPE, -706, 3904, 16020, 0, 90, 0, (0x20 << 16), bhvWarpPipe),
		OBJECT(MODEL_THI_WARP_PIPE, -6617, 614, 14499, 0, -90, 0, (0x21 << 16), bhvWarpPipe),
	...
	AREA(2, cg_area_2, -6000, -957, -2000),
		...
		OBJECT(MODEL_THI_WARP_PIPE, -323, -2809, -12054, 0, 0, 0, (0x22 << 16), bhvWarpPipe),
	...
	AREA(3, cg_area_3, -10000, -998, -2000),
		...
		OBJECT(MODEL_THI_WARP_PIPE, 17249, -666, -18057, 0, 0, 0, (0x23 << 16), bhvWarpPipe),
