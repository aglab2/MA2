...
const LevelScript level_ph_entry[] = {
	...
	AREA(1, ph_area_1, 0, 0, 0),
		...
		OBJECT(MODEL_PURPLE_SWITCH, 8560, -9133, -6551, 0, 0, 0, 0x00000000, bhvFloorSwitchHiddenObjects),
		OBJECT(MODEL_PURPLE_SWITCH, 8882, -7267, -10999, 0, -50, 0, (1 << 16), bhvFloorSwitchHiddenObjects),
