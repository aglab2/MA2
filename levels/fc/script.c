...
const LevelScript level_fc_entry[] = {
	...
	AREA(2, fc_area_2, 4000, -3949, 2000),
		...
		OBJECT(MODEL_NONE, -8115, -6759, 14795, 0, 90, 0, 0x00000000, bhvCoinFormation),
		OBJECT(MODEL_NONE, -5977, -6259, 15754, 0, -180, 0, 0x00000000, bhvCoinFormation),
		OBJECT(MODEL_NONE, -3028, -6259, 14822, 0, -90, 0, 0x00000000, bhvCoinFormation),
		OBJECT(MODEL_NONE, -4076, -5759, 26816, 0, -90, 0, 0x00000000, bhvCoinFormation),
		OBJECT(MODEL_NONE, -4034, -4259, 31788, 0, -90, 0, 0x00000000, bhvCoinFormation),
	...
	AREA(3, fc_area_3, 4000, -3949, 6000),
		...
		OBJECT(MODEL_NONE, 3662, -11966, 12857, 90, 0, 0, (2 << 16), bhvFCGrav),
