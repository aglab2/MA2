...
const LevelScript level_ccs_entry[] = {
	...
	AREA(1, ccs_area_1, 0, 0, 2000-3000),
		...
		OBJECT(MODEL_FLYGUY, 4494, -4553, 11685, 0, 0, 0, (2 << 16), bhvFlyGuy),
		OBJECT(MODEL_FLYGUY, 4494, -4553, 12688, 0, 0, 0, (2 << 16), bhvFlyGuy),
		OBJECT(MODEL_FLYGUY, 4220, -4283, 12199, 0, -180, 0, (2 << 16), bhvFlyGuy),
		OBJECT(MODEL_FLYGUY, 3740, -4283, 12716, 0, -180, 0, (2 << 16), bhvFlyGuy),
		OBJECT(MODEL_FLYGUY, 3740, -4283, 11713, 0, -180, 0, (2 << 16), bhvFlyGuy),
		...
		OBJECT(MODEL_NONE, -5102, -6550, -14106, 0, -180, 0, 0x00000000, bhvShutter),
		OBJECT(MODEL_SNUFIT, -4511, -5040, 5267, 0, 0, 0, 0x00000000, bhvSnufit),
		OBJECT(MODEL_SNUFIT, -5564, -5040, 5267, 0, 0, 0, 0x00000000, bhvSnufit),
		OBJECT(MODEL_SNUFIT, -5127, -4519, 3233, 0, 0, 0, 0x00000000, bhvSnufit),
		OBJECT(MODEL_NONE, -5690, -4592, 3223, 0, 0, 0, 0x00000000, bhvCCSpawn),
