...
static struct FlipbookData flipbooks_xlu[] = {
    { LVL_BATCH_LAYER_TRANSPARENT_CCS_DL_KD_LK_WATER1_01_PAL_RGBA16, .tileScrollY=-5,  },
    { LVL_BATCH_LAYER_TRANSPARENT_CCS_DL_KD_LS_WATER1_001_PAL_RGBA16, .tileScrollY=-5,  },
    { LVL_BATCH_LAYER_TRANSPARENT_CCS_DL_KD_LK_WATER1_01_PAL_RGBA16_1, .tileScrollX=-5,  },
    { LVL_BATCH_LAYER_TRANSPARENT_CCS_DL_KD_LS_WATER1_001_PAL_RGBA16_1, .tileScrollY=-5,  },
    //{ LVL_BATCH_LAYER_TRANSPARENT_CCS_DL_KD_LS_WATER1_001_PAL_RGBA16_2, .tileScrollY=-2,  },
