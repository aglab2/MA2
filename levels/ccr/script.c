...
const LevelScript level_ccr_entry[] = {
	...
	AREA(1, ccr_area_1, 0, 0, 0),
		...
		OBJECT(MODEL_NONE, -3, -952, -4612, 0, 0, 0, (2 << 16), bhvCCSpawn),
		OBJECT(MODEL_NONE, 580, -1700, -4950, 0, 0, 0, (5 << 16), bhvCCSpawn),
		OBJECT(MODEL_NONE, -502, -1700, -4950, 0, 0, 0, (6 << 16), bhvCCSpawn),
		OBJECT(MODEL_NONE, 580, -1700, -6050, 0, 0, 0, (6 << 16), bhvCCSpawn),
		OBJECT(MODEL_NONE, -502, -1700, -6050, 0, 0, 0, (5 << 16), bhvCCSpawn),
		...
		OBJECT(MODEL_CCR_CAPSULE, 0, 300, 0, 0, 0, 0, 0x00000000, bhvCCRCapsule),
		...
		OBJECT(MODEL_CCR_TIMESTOP, -4, -1500, -6500, 90, 0, 0, 0x00000000, bhvCCTimestop),
