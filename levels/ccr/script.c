...
const LevelScript level_ccr_entry[] = {
	...
	AREA(1, ccr_area_1, 0, 0, 0),
		...
		OBJECT(MODEL_STAR, -3, -368, 2102, 0, 0, 0, 0x00000000, bhvStar),
		...
		OBJECT(MODEL_STAR, 789, 3452, -799, 0, 0, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_STAR, -16, 1048, -5536, 0, 0, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_STAR, -26, -263, -7678, 0, 0, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_STAR, 2082, 0, 73, 0, 0, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_NONE, 1202, 600, 0, 0, 0, 0, (0xa << 16), bhvInstantActiveWarp),
