...
const LevelScript level_ce_entry[] = {
	...
	AREA(3, ce_area_3, 0, -6071, 9000),
		...
		WARP_NODE(0xf0, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xf1, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_BREAKABLE_BOX, -15786, 729, -4956, 0, 0, 0, (1 << 24), bhvBreakableBox),
		OBJECT(MODEL_BREAKABLE_BOX, -12967, -1820, 4428, 0, 0, 0, 0x00000000, bhvBreakableBox),
		OBJECT(MODEL_BREAKABLE_BOX, -15064, 1316, -5336, 0, 0, 0, (1 << 24), bhvBreakableBox),
		OBJECT(MODEL_BREAKABLE_BOX, -15064, 1316, -5536, 0, 0, 0, (1 << 24), bhvBreakableBox),
		OBJECT(MODEL_BREAKABLE_BOX, -15502, 1679, -6234, 0, 0, 0, (1 << 24), bhvBreakableBox),
		OBJECT(MODEL_BREAKABLE_BOX, -15502, 1879, -6234, 0, 0, 0, (1 << 24), bhvBreakableBox),
		OBJECT(MODEL_BREAKABLE_BOX, -15502, 1879, -6434, 0, 0, 0, (1 << 24), bhvBreakableBox),
		...
		OBJECT(MODEL_NONE, -9395, -1390, 4256, 0, 0, 0, 0x00000000, bhvCoinFormation),
