...
const LevelScript level_ce_entry[] = {
	...
	AREA(3, ce_area_3, 0, -6071, 9000),
		...
		OBJECT(MODEL_CE_HAMMER, 3699, -4404, 8589, 0, 0, 0, (0 << 16), bhvHammerUpDown),
		OBJECT(MODEL_CE_HAMMER, 3699, -4096, 8372, 0, 0, 0, (120 << 16), bhvHammerUpDown),
		OBJECT(MODEL_CE_HAMMER, 3699, -3789, 8155, 0, 0, 0, (0 << 16), bhvHammerUpDown),
		...
		OBJECT(MODEL_STAR, 3753, -3538, 8371, 0, 0, 0, (10 << 24), bhvStar),
	...
	AREA(6, ce_area_6, 8000, -12556, 5000),
		...
		OBJECT(MODEL_CE_HAMMER, -4613, -18990, 12168, 0, 0, 0, (0 << 16), bhvHammerUpDown),
		OBJECT(MODEL_CE_HAMMER, -4830, -18990, 12168, 0, 0, 0, (0 << 16), bhvHammerUpDown),
		OBJECT(MODEL_CE_HAMMER, -5773, -18990, 12652, 0, 0, 0, (80 << 16), bhvHammerUpDown),
		OBJECT(MODEL_CE_HAMMER, -6023, -18990, 12777, 0, 0, 0, (80 << 16), bhvHammerUpDown),
		OBJECT(MODEL_CE_HAMMER, -6814, -18990, 12420, 0, 0, 0, (160 << 16), bhvHammerUpDown),
		OBJECT(MODEL_CE_HAMMER, -7064, -18990, 12295, 0, 0, 0, (160 << 16), bhvHammerUpDown),
