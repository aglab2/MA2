...
const LevelScript level_ce_entry[] = {
	...
	AREA(3, ce_area_3, 0, -6071, 9000),
		...
		OBJECT(MODEL_BREAKABLE_BOX, -15013, 2170, -6663, 0, 0, 0, 0x00000000, bhvHiddenObject),
		...
		OBJECT(MODEL_PURPLE_SWITCH, -15387, 112, -3994, 0, 0, 0, 0x00000000, bhvFloorSwitchHiddenObjects),
