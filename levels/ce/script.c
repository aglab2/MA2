...
const LevelScript level_ce_entry[] = {
	...
	AREA(6, ce_area_6, 8000, -12556, 5000),
		...
		OBJECT(MODEL_NONE, -3808, -20122, 4540, 0, 0, 0, (0x21 << 16), bhvWarpPipe),
	...
	AREA(7, ce_area_7, 8000, -15682, 9000),
		...
		OBJECT(MODEL_THI_WARP_PIPE, -15605, -2446, 2121, 0, 0, 0, (2 << 16), bhvWarpPipe),
	...
	AREA(8, ce_area_8, 8000, -17675, 13000),
		...
		WARP_NODE(0xf0, LEVEL_CASTLE_GROUNDS, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xf1, LEVEL_CASTLE_GROUNDS, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_NONE, -15624, -2217, -1183, 0, -180, 0, (4 << 16), bhvCoinFormation),
		OBJECT(MODEL_NONE, -15635, -12507, 16512, 0, -180, 0, (4 << 16), bhvCoinFormation),
