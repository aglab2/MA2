...
const LevelScript level_gf_entry[] = {
	...
	AREA(4, gf_area_4, 9600, -980, 10300),
		...
		OBJECT(MODEL_GF_GAKE_A, 10846, -13267, 7490, 0, 90, 0, 0x00000000, bhvGfGake),
		OBJECT(MODEL_GF_GAKE_B, 10046, -13267, 8290, 0, 90, 0, (1 << 16), bhvGfGake),
		OBJECT(MODEL_GF_GAKE_C, 8446, -13267, 7490, 0, 90, 0, (2 << 16), bhvGfGake),
		OBJECT(MODEL_GF_GAKE_D, 7646, -13267, 8240, 0, 90, 0, (3 << 16), bhvGfGake),
		OBJECT(MODEL_GF_GAKE_E, 6046, -13267, 7490, 0, 90, 0, (4 << 16), bhvGfGake),
		OBJECT(MODEL_GF_GAKE_F, 5246, -13267, 8240, 0, 90, 0, (5 << 16), bhvGfGake),
