...
const LevelScript level_gf_entry[] = {
	...
	AREA(1, gf_area_1, 1600, -521, 2300),
		...
		OBJECT(MODEL_CHECKPOINT, 2245, -3144, 6113, 0, 0, 0, 0x00000000, bhvCheckpoint),
	...
	AREA(2, gf_area_2, 5600, -1545, 6300),
		...
		OBJECT(MODEL_CHECKPOINT, 26064, -2517, 15666, 0, 0, 0, 0x00000000, bhvCheckpoint),
		OBJECT(MODEL_CHECKPOINT, 29113, 6453, 23693, 0, 0, 0, 0x00000000, bhvCheckpoint),
	...
	AREA(3, gf_area_3, 9600, -980, 6300),
		...
		OBJECT(MODEL_STAR, -17045, -7960, 15262, 0, 0, 0, 0x00000000, bhvStar),
	...
	AREA(4, gf_area_4, 9600, -980, 10300),
		...
		OBJECT(MODEL_NONE, -14531, -6630, 1218, 0, 0, 0, 0x00000000, bhvHiddenRedCoinStar),
		OBJECT(MODEL_NONE, -14433, -7139, 2754, 0, 0, 0, 0x00000000, bhvHiddenRedCoinStar),
		OBJECT(MODEL_NONE, -14258, -7498, 3823, 0, 0, 0, 0x00000000, bhvHiddenRedCoinStar),
		OBJECT(MODEL_NONE, -13682, -7931, 5094, 0, 0, 0, 0x00000000, bhvHiddenRedCoinStar),
		OBJECT(MODEL_NONE, -13017, -8247, 5878, 0, 0, 0, 0x00000000, bhvHiddenRedCoinStar),
		OBJECT(MODEL_NONE, -11434, -8738, 6864, 0, 0, 0, 0x00000000, bhvHiddenRedCoinStar),
		OBJECT(MODEL_NONE, -9799, -9048, 7176, 0, 0, 0, 0x00000000, bhvHiddenRedCoinStar),
		OBJECT(MODEL_NONE, -8537, -9189, 7253, 0, 0, 0, 0x00000000, bhvHiddenRedCoinStar),
