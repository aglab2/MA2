...
const Gfx ow2_dl_billboard_num_begin[] = {
    gsDPPipeSync(),
...
extern const Gfx ow2_dl_billboard_num_end[] = {
...
const Gfx ow2_dl_billboard_num_0[] = {
    gsSPDisplayList(ow2_dl_billboard_num_begin),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, texture_hud_char_0),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, ((16 * 16) - 1), CALC_DXT(16, G_IM_SIZ_16b_BYTES)),
    gsSPDisplayList(ow2_dl_billboard_num_end),
    gsDPSetAlphaCompareReal(G_AC_NONE),
    gsSPEndDisplayList(),
};

const Gfx ow2_dl_billboard_num_1[] = {
    gsSPDisplayList(ow2_dl_billboard_num_begin),
...
const Gfx ow2_dl_billboard_num_2[] = {
    gsSPDisplayList(ow2_dl_billboard_num_begin),
...
const Gfx ow2_dl_billboard_num_3[] = {
    gsSPDisplayList(ow2_dl_billboard_num_begin),
...
const Gfx ow2_dl_billboard_num_4[] = {
    gsSPDisplayList(ow2_dl_billboard_num_begin),
...
const Gfx ow2_dl_billboard_num_5[] = {
    gsSPDisplayList(ow2_dl_billboard_num_begin),
...
const Gfx ow2_dl_billboard_num_6[] = {
    gsSPDisplayList(ow2_dl_billboard_num_begin),
...
const Gfx ow2_dl_billboard_num_7[] = {
    gsSPDisplayList(ow2_dl_billboard_num_begin),
...
const Gfx ow2_dl_billboard_num_8[] = {
    gsSPDisplayList(ow2_dl_billboard_num_begin),
...
const Gfx ow2_dl_billboard_num_9[] = {
    gsSPDisplayList(ow2_dl_billboard_num_begin),
...
const Gfx ow2_dl_billboard_num_percent[] = {
    gsSPDisplayList(ow2_dl_billboard_num_begin),
...
const Gfx ow2_dl_billboard_num_C[] = {
    gsSPDisplayList(ow2_dl_billboard_num_begin),
...
const Gfx ow2_dl_billboard_num_L[] = {
    gsSPDisplayList(ow2_dl_billboard_num_begin),
...
const Gfx ow2_dl_billboard_num_E[] = {
    gsSPDisplayList(ow2_dl_billboard_num_begin),
...
const Gfx ow2_dl_billboard_num_A[] = {
    gsSPDisplayList(ow2_dl_billboard_num_begin),
...
const Gfx ow2_dl_billboard_num_R[] = {
    gsSPDisplayList(ow2_dl_billboard_num_begin),
...
const Gfx ow2_dl_billboard_num_O[] = {
    gsSPDisplayList(ow2_dl_billboard_num_begin),
...
const Gfx ow2_dl_billboard_num_U[] = {
    gsSPDisplayList(ow2_dl_billboard_num_begin),
...
const Gfx ow2_dl_billboard_num_S[] = {
    gsSPDisplayList(ow2_dl_billboard_num_begin),
