...
const LevelScript level_fr_entry[] = {
	...
	AREA(1, fr_area_1, 3500, -1213, 1000),
		...
		OBJECT(MODEL_NONE, -23588, 12730, -9995, 0, 0, 0, (0xa << 16), bhvInstantActiveWarp),
	...
	AREA(10, fr_area_10, 3500, -19137, 17000),
		...
		OBJECT(MODEL_SNUFIT, -10090, -8521, -17072, 0, 0, 0, 0x00000000, bhvSnufit),
	...
	AREA(2, fr_area_2, 3500, -4743, 5000),
		...
		OBJECT(MODEL_YELLOW_COIN, 14153, -7345, 1195, 0, 0, 0, 0x00000000, bhvYellowCoin),
	...
	AREA(8, fr_area_8, 7500, -15209, 21000),
		...
		OBJECT(MODEL_SCUTTLEBUG, -17410, -9779, 7706, 0, 90, 0, 0x00000000, bhvScuttlebug),
