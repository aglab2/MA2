...
const LevelScript level_fr_entry[] = {
	...
	AREA(1, fr_area_1, 3500, -1213, 1000),
		...
		OBJECT(MODEL_STAR, 7908, -11073, 14011, 0, 0, 0, 0x00000000, bhvStar),
	...
	AREA(10, fr_area_10, 3500, -19137, 17000),
		...
		OBJECT(MODEL_STAR, -13555, -7073, -14998, 0, 0, 0, 0x00000000, bhvStar),
	...
	AREA(13, fr_area_13, 3500, -25885, 9000),
		...
		WARP_NODE(0x20, LEVEL_CG, 0x01, 0x21, WARP_NO_CHECKPOINT),
		WARP_NODE(0x21, LEVEL_CG, 0x01, 0x20, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_NONE, -9667, -5685, -13569, 0, 0, 0, (17 << 16), bhvCoinFormation),
	...
	AREA(2, fr_area_2, 3500, -4743, 5000),
		...
		WARP_NODE(0x20, LEVEL_CG, 0x01, 0x21, WARP_NO_CHECKPOINT),
		WARP_NODE(0x21, LEVEL_CG, 0x01, 0x20, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_NONE, 7937, 13509, -16364, 0, -180, 0, (0 << 16), bhvCoinFormation),
	...
	AREA(3, fr_area_3, 3500, -7762, 5000),
		...
		WARP_NODE(0x20, LEVEL_CG, 0x01, 0x21, WARP_NO_CHECKPOINT),
		WARP_NODE(0x21, LEVEL_CG, 0x01, 0x20, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_RED_COIN, 7446, 13291, -10988, 0, 0, 0, 0x00000000, bhvRedCoin),
	...
	AREA(4, fr_area_4, 7500, -11312, 5000),
		...
		OBJECT(MODEL_STAR, 3300, 6753, 16330, 0, 0, 0, 0x00000000, bhvStar),
	...
	AREA(5, fr_area_5, 7500, -12748, 9000),
		...
		OBJECT(MODEL_CHUCKYA, -8464, -12873, 4810, 0, 0, 0, 0x00000000, bhvChuckya),
		...
		OBJECT(MODEL_RED_COIN, 2870, 15028, -17890, 0, 0, 0, 0x00000000, bhvRedCoin),
		...
		OBJECT(MODEL_STAR, 3143, 13039, -9676, 0, 0, 0, 0x00000000, bhvHiddenRedCoinStar),
	...
	AREA(6, fr_area_6, 7500, -14169, 13000),
		...
		OBJECT(MODEL_CHUCKYA, -9402, -7318, 9187, 0, 0, 0, 0x00000000, bhvChuckya),
		OBJECT(MODEL_CHUCKYA, -10920, -2818, 7588, 0, 0, 0, 0x00000000, bhvChuckya),
