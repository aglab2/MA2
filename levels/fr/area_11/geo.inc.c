...
const GeoLayout fr_area_11_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, (s16)0.0, (s16)-7468.0975341796875, (s16)0.0, fr_dl_a1_033_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, (s16)-17258.3935546875, (s16)11935.57861328125, (s16)-15541.474609375, fr_dl_a5_coll_002_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
