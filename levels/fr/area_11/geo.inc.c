...
const GeoLayout fr_area_11_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, (s16)0.0, (s16)2127.6661682128906, (s16)0.0, fr_dl_a1_032_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, (s16)0.0, (s16)-7468.115234375, (s16)0.0, fr_dl_a1_033_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
