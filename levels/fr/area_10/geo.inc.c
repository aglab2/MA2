...
const GeoLayout fr_area_10_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, (s16)0.0, (s16)2127.6797485351562, (s16)0.009765625, fr_dl_a1_032_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, (s16)0.0, (s16)-7468.1011962890625, (s16)0.009765625, fr_dl_a1_033_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
